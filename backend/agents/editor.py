...
class EditorAgent:
    ...
    def editor(self, articles):
        ...
        for article in articles:
            ...
            article_html = article_html.replace("{{image}}", "https://h7.alamy.com/comp/2AHHNH4/math-on-black-board-with-many-solution-2AHHNH4.jpg")
        ...
        html_template = html_template.replace("{{date}}", str_date)
